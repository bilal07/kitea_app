    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="{{ url('/editRecord', array($records->id)) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="record_title" type="record_title" class="form-control @error('record_title') is-invalid @enderror" name="record_title" value="{{ $records->record_title }}" required autocomplete="record_title" autofocus>
